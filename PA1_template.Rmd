...
```{r Transform Data, echo=TRUE, message=FALSE}
...
```{r Total Daily Steps Histogram, echo=TRUE, message=FALSE, warning=FALSE, fig.path='figure/'}
...
```{r Mean and Median Daily Steps, echo=TRUE, message=FALSE}
...
```{r Average Daily Activity, echo=TRUE, message=FALSE, fig.path='figure/'}
...
```{r Max Avergae interval, echo=TRUE, message=FALSE}
...
```{r Calculating Missing Vales, echo=TRUE, message=FALSE}
...
```{r Impute Missing Values, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Extra data to new dataframe, echo=TRUE, message=FALSE}
...
```{r Compare histogram of total step and mean and median, echo=TRUE, warning=FALSE, message=FALSE, fig.path='figure/'}
# Create a summary table of total steps per day
...
```{r Factor variable for weekday, echo=TRUE, warning=FALSE}
...
```{r Weekday vs Weekend Mean Steps, echo=TRUE, warning=FALSE, fig.path='figure/'}
# Create a summary table of mean steps per interval
